        ...
        {projets.map((card, idx) => (
          <div key={idx} className="flex flex-col justify-between h-[430px] bg-gray-900 border border-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-200" >
            ...
            <div className="p-5 flex flex-col flex-grow">
              ...
              <a href={card.page} className="inline-flex items-center justify-center px-3 py-2 text-sm font-medium text-white rounded-md group bg-gradient-to-br from-cyan-500 to-blue-900 hover:from-cyan-200 hover:to-blue-600 transition " >
                Lire plus
